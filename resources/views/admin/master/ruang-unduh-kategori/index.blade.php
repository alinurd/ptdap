...
@include('admin.master.ruang-unduh-kategori._modal', ['prefixRoute' => $prefixRoute, 'title' => $title])
@endsection
@push('js')
    @include('admin.master.ruang-unduh-kategori._scripts', ['prefixRoute' => $prefixRoute])
@endpush
