        ...
        <x-table-btn>
            ...
            <x-slot name="tbody">
                ...
                <tr>
                    ...
                    <td>
                        @if($item->icon)
                            <img src="{{ asset($item->icon) }}" width="40" height="40" class="rounded">
                        @else
                    ...
                    <td>
                        <label class="switch">
                            <input type="checkbox" class="switch-input" id="status{{ $item->id }}"
...
@include('admin.master.bisnis-kategori._modal', ['prefixRoute' => $prefixRoute, 'title' => $title])
@endsection
@push('js')
    @include('admin.master.bisnis-kategori._scripts', ['prefixRoute' => $prefixRoute])
@endpush
