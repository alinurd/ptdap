<script>
    CKEDITOR.replace('persyaratan', CKEDITORGlobalOptions);
    ...
    function saveData() {
        ...
        jsonData['persyaratan'] = CKEDITOR.instances['persyaratan'].getData();
    ...
    function btnEditItem(url, id) {
        $.get(url, function(res) {
            if (res.status == 'success') {
                ...
                $('#data_id').val(id);
                CKEDITOR.instances['persyaratan'].setData(res.data[0]['persyaratan'] ?? '');
    ...
    function openForm() {
        ...
        CKEDITOR.instances['persyaratan'].setData('');
