        ...
        <x-table-btn>
            ...
            <x-slot name="tbody">
                ...
                <tr>
                    ...
                    <td>
                        @if($item->image)
                            <img src="{{ asset($item->image) }}" width="40" height="40" class="rounded me-2" style="object-fit:cover;">
                        @else
                            <img src="{{ asset('assets/img/noimage.jpg') }}" width="40" height="40" class="rounded me-2" style="object-fit:cover;">
                        @endif
                        {{ $item->judul }}
                    </td>
                    <td>{{ $item->tanggal_tutup ? \Carbon\Carbon::parse($item->tanggal_tutup)->format('d M Y') : '-' }}</td>
                    <td>{{ $item->sort }}</td>
                    <td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="{{ route('admin.master.karir.fields.index', $item->id) }}"><i data-feather="list"></i> Kelola Form</a></li>
                                <li><a class="dropdown-item" href="{{ route('admin.master.karir.lamaran.index', $item->id) }}"><i data-feather="users"></i> Lihat Pelamar</a></li>
...
@include('admin.master.karir._modal', ['prefixRoute' => $prefixRoute, 'title' => $title])
@endsection
@push('js')
    @include('admin.master.karir._scripts', ['prefixRoute' => $prefixRoute])
@endpush
