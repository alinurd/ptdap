...
@include('admin.master.dokumen-kategori._modal', ['prefixRoute' => $prefixRoute, 'title' => $title])
@endsection
@push('js')
    @include('admin.master.dokumen-kategori._scripts', ['prefixRoute' => $prefixRoute])
@endpush
