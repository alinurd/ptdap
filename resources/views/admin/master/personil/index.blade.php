        ...
        <x-table-btn>
            ...
            <x-slot name="tbody">
                ...
                <tr>
                    ...
                    <td>
                        @if($item->foto)
                            <img src="{{ asset($item->foto) }}" width="45" height="45" class="rounded-circle">
                        @else
                            <img src="{{ asset('assets/img/noimage.jpg') }}" width="45" height="45" class="rounded-circle">
                        @endif
                    </td>
                    <td>{{ $item->nama }}</td>
                    <td>{{ $item->jabatan }}</td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="javascript:void(0);" onclick="btnDeleteItem('{{ route($prefixRoute.'delete', $item->id) }}', '{{ $item->nama }}')"><i data-feather="trash"></i> Hapus</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
...
@include('admin.master.personil._modal', ['prefixRoute' => $prefixRoute, 'title' => $title])
@endsection
@push('js')
    @include('admin.master.personil._scripts', ['prefixRoute' => $prefixRoute])
@endpush
