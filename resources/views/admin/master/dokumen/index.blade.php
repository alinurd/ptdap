...
@include('admin.master.dokumen._modal', ['prefixRoute' => $prefixRoute, 'title' => $title, 'kategoris' => $kategoris])
@endsection
@push('js')
    @include('admin.master.dokumen._scripts', ['prefixRoute' => $prefixRoute])
@endpush
